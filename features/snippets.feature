Feature: undefined step snippets
  ...
  Scenario: should generate snippets with step_func snippet func when snippet func is not found
  ...
  Scenario: should generate snippets with step_func snippet func
    Given a feature "undefined.feature" file:
      """
      Feature: undefined steps
        ...
        Scenario: get version number from api
          ...
          Then the response code should be 200
      """
    And snippet function is: "step_func"
    When I run feature suite
    Then the following steps should be undefined:
      """
      I send "GET" request to "/version"
  ...
  Scenario: should generate snippets with gwt_func snippet func
    Given a feature "undefined.feature" file:
      """
      Feature: undefined steps
        ...
        Scenario: get version number from api
          ...
          Then the response code should be 200
      """
    And snippet function is: "gwt_func"
    When I run feature suite
    Then the following steps should be undefined:
      """
      I send "GET" request to "/version"
  ...
  Scenario: should generate snippets with more arguments with gwt_func snippet func
    Given a feature "undefined.feature" file:
      """
      Feature: undefined steps
  ...
  Scenario: should handle escaped symbols with gwt_func snippet func
    Given a feature "undefined.feature" file:
      """
      Feature: undefined steps
  ...
  Scenario: should handle string argument followed by comma with gwt_func snippet func
    Given a feature "undefined.feature" file:
      """
      Feature: undefined
    ...
    And the undefined step snippets should be:
      ...
      func InitializeScenario(ctx *godog.ScenarioContext) {
              ctx.When(`^I add the "([^"]*)" to the basket$`, iAddTheToTheBasket)
              ctx.Given(`^there is a "([^"]*)", which costs £(\d+)$`, thereIsAWhichCosts)
      }
      """

  Scenario: should handle arguments in the beginning or end of the step
    Given a feature "undefined.feature" file:
      """
      Feature: undefined
  ...
  Scenario: should handle arguments in the beginning or end of the step with gwt_func snippet func
    Given a feature "undefined.feature" file:
      """
      Feature: undefined
