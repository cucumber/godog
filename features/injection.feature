  ...
  Scenario: Support data injection in BeforeStep with various formatters
    ...
    Feature: inject long value
      ...
      Scenario: test scenario                              # features/inject.feature:3
        ...
        When IgnoredStep: Inject step someverylonginjectionsoweacanbesureitsurpasstheinitiallongeststeplenghtanditwillhelptestsmethodsafety # feature_test.go:<autogenerated> -> <autogenerated>
        And IgnoredStep: Inject table                      # feature_test.go:<autogenerated> -> <autogenerated>
          | injectedCol                                                                                           | val |
          | someverylonginjectionsoweacanbesureitsurpasstheinitiallongeststeplenghtanditwillhelptestsmethodsafety | 2   |
        And IgnoredStep: Inject doc string:                # feature_test.go:<autogenerated> -> <autogenerated>
          \"\"\"
            Injected docstring : {{PLACEHOLDER3}}
          \"\"\"
        Then IgnoredStep: Godog rendering should not break # feature_test.go:<autogenerated> -> <autogenerated>
      ...
      Scenario Outline: test scenario outline               # features/inject.feature:16
        Given I allow variable injection                    # <autogenerated>:1 -> *godogFeaturesScenarioInner
        When IgnoredStep: Inject example step <injectedCol> # feature_test.go:<autogenerated> -> <autogenerated>
        And I disable variable injection                    # <autogenerated>:1 -> *godogFeaturesScenarioInner
