Feature: cucumber json formatter
  Smoke test of cucumber formatter.
  ...
  Scenario: check formatter is available
    ...
    [
        {
            "uri": "test.feature",
            "id": "check-the-formatter-is-available",
            "keyword": "Feature",
            "name": "check the formatter is available",
            "description": "",
            "line": 1,
            "elements": [
                {
                    "id": "check-the-formatter-is-available;trivial-scenario",
                    "keyword": "Scenario",
                    "name": "trivial scenario",
                    "description": "",
                    "line": 2,
                    "type": "scenario",
                    "steps": [
